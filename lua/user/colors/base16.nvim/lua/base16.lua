...
Base16.setup = function()
  ...
  -- Check for BASE16_COLOR_00_HEX environment variable
  -- If it exists, use its value; otherwise, use a default color
  ...
  highlight_both("Comment", { fg = { gui = palette.base0C, cterm = cterm_palette.base0C }, attr = "italic" })
